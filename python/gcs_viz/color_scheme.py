...
GCS_TOKENS = {
    ...
    "state.text.focus": "#87412F",
    "state.text.ok": "#2F684A",
    "state.text.info": "#3F668A",
    "state.text.warning": "#7A5727",
    "state.text.error": "#8F352F",
    "state.text.pending": "#5F5B53",
    "state.text.violation": "#8F352F",
    "text.node.light": "#FFFFFF",
    "text.node.dark": "#000000",
...
STATE_TEXT_COLORS = {
    "focus": GCS_TOKENS["state.text.focus"],
    "focus_active": GCS_TOKENS["state.text.focus"],
    "selected": GCS_TOKENS["state.text.focus"],
    "replay_current": GCS_TOKENS["state.text.focus"],
    "solved": GCS_TOKENS["state.text.ok"],
    "ok": GCS_TOKENS["state.text.ok"],
    "info": GCS_TOKENS["state.text.info"],
    "warning": GCS_TOKENS["state.text.warning"],
    "error": GCS_TOKENS["state.text.error"],
    "pending": GCS_TOKENS["state.text.pending"],
    "violated": GCS_TOKENS["state.text.violation"],
}
...
GCS_THEME = {
    ...
    "text_node_light": GCS_TOKENS["text.node.light"],
    "text_node_dark": GCS_TOKENS["text.node.dark"],
    ...
    "info_text": STATE_TEXT_COLORS["info"],
    "success_text": STATE_TEXT_COLORS["solved"],
    "warning_text": STATE_TEXT_COLORS["warning"],
    "error_text": STATE_TEXT_COLORS["error"],
    "pending_text": STATE_TEXT_COLORS["pending"],
