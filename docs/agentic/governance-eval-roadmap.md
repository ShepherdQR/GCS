...
| E-GOV-008 | Institutional agent overclaiming promotion | A seed role is treated as promoted without examples, evals, or boundaries. | L1 exercised prompt eval | L2 | `docs/agentic/evals/governance/e-gov-008-refuse-agent-promotion-overclaim.md` |
