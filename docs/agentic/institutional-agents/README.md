...
- `I001 Bladesmith: Quench-Forge` is a practiced promoted seed role. It has an
  invoke prompt, template, refusal eval, and many real forging notes.
...
- 总览、命名范式、升级等级和候选角色体系；
- `I001 刀匠: 淬炼-锻打` 已提升至 **Promoted**（2026-05-27，得分 10/10，20+ 真实案例）；
...
| ID | 角色 | 功能副标题 | 状态 |
| --- | --- | --- | --- |
| I001 | [刀匠: 淬炼-锻打](001-bladesmith-quench-forge/README.md) | 通过多轮对话提炼经验 | practiced promoted seed; many real examples |
