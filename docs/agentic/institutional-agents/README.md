...
- `I003 Atelier Steward: Calibrate-Review` remains seed until a real UI or
  figure governance task creates prompt/template/eval/example artifacts.
- `I004 Art Director: Frame-Judge` remains seed until a real visual review task
  creates prompt/template/eval/example artifacts.
