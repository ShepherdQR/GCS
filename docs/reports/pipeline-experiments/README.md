...
Each experiment lives in `NNN-slug/` with at minimum a `README.md`.
Key findings flow upward into architecture docs when they reveal
structural issues.
